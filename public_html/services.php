        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="hero-content">
                    <h1 data-aos="fade-up">Comprehensive Logistics Services</h1>
                    <p data-aos="fade-up" data-aos-delay="100">
                        End-to-end freight solutions tailored to your business requirements across all transportation modes.
                    </p>
                </div>
            </div>
        </div>
